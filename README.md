...
| filename_path | bool | Whether to show the full path of the filename or just the filename. Default is False, which will only show the filename. | True |
